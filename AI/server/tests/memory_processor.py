...
class MemoryProcessor:
    def __init__(self, memory_file_path: str):
        ...
        self.today_str = "2025.05.06"  # memories.json에 있는 최신 날짜로 설정
    ...
    def filter_todays_memories(self, agent_name: str, date_str: str = None) -> List[Dict]:
        ...
        logger.info(f"에이전트 '{agent_name}'의 {date_str} 날짜 메모리 {len(todays_memories)}개를 필터링했습니다.")
        return todays_memories
